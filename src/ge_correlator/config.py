"""Configuration management for correlator-ge.
...
DEFAULT_CONFIG_FILENAMES = (".correlator-ge.yml", ".correlator-ge.yaml")

# Mapping from YAML nested keys to config field names
# Will be expanded after Task 2.2 research
...
def load_yaml_config(config_path: Optional[Path] = None) -> dict[str, Any]:
    ...
    2. .correlator-ge.yml or .correlator-ge.yaml in current directory
    3. .correlator-ge.yml or .correlator-ge.yaml in home directory
    ...
    Example:
        >>> config = load_yaml_config(Path(".correlator-ge.yml"))
